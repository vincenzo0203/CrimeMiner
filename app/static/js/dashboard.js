...
function unPinnable(){
    document.querySelector(".btnPinnableMenu").innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" fill="currentColor" class="bi bi-pin-angle" viewBox="0 0 16 16">
...
function pinnable(){
    document.querySelector(".btnPinnableMenu").innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" fill="currentColor"
